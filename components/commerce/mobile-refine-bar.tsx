...
export function MobileRefineBar({ totalCount }: MobileRefineBarProps) {
  ...
  return (
    <>
      <div className="md:hidden fixed bottom-0 inset-x-0 z-30 glass-strong border-t border-gray-200 rounded-t-3xl shadow-xl">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3 sheet-safe-bottom">
          <button
            onClick={() => setShowFilterDrawer(true)}
            className="flex-1 h-11 inline-flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white text-sm font-medium hover:bg-gray-50 hover:border-gray-400 active:bg-gray-100 transition-colors duration-fast touch-manipulation"
