...
export function MobileSearchDropdown() {
  ...
  return (
    <div ref={searchRef} className="relative">
      ...
      <div 
        className={cn(
          "fixed top-[90px] left-3 right-3 sm:absolute sm:top-full sm:left-auto sm:right-0 sm:mt-2 sm:w-[380px] bg-white border border-gray-200 shadow-xl rounded-lg overflow-hidden transition-all duration-200 z-50",
