...
export function SearchFiltersAccordion() {
  ...
  return (
    <div className="bg-white border-2 border-black/10 shadow-sm">
            ...
            {hasActiveFilters && (
              <div className="pt-2 border-t border-gray-200">
                <Button
                  ...
                  className="font-mono text-xs h-9 px-4 border-black hover:bg-black hover:text-white transition-all"
                >
                  Clear All Filters
                </Button>
              </div>
